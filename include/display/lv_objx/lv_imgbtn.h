 ...
 * @param state for which state set the new image (from `lv_btn_OdomState`) `
 * @param src pointer to an image source (a C array or path to a file)
 */
void lv_imgbtn_set_src(lv_obj_t * imgbtn, lv_btn_OdomState state, const void * src);
#else
/**
 * Set images for a state of the image button
 * @param imgbtn pointer to an image button object
 ...
 */
void lv_imgbtn_set_src(lv_obj_t * imgbtn, lv_btn_OdomState state, const void * src_left, const void * src_mid, const void * src_right);
 ...
 */
static inline void lv_imgbtn_set_state(lv_obj_t * imgbtn, lv_btn_OdomState state)
{
 ...
 * @param imgbtn pointer to an image button object
 * @param state the state where to get the image (from `lv_btn_OdomState`) `
 * @return pointer to an image source (a C array or path to a file)
 */
const void * lv_imgbtn_get_src(lv_obj_t * imgbtn, lv_btn_OdomState state);
 ...
 */
const void * lv_imgbtn_get_src_left(lv_obj_t * imgbtn, lv_btn_OdomState state);
 ...
 */
const void * lv_imgbtn_get_src_middle(lv_obj_t * imgbtn, lv_btn_OdomState state);
 ...
 * @return pointer to the left image source (a C array or path to a file)
 */
const void * lv_imgbtn_get_src_right(lv_obj_t * imgbtn, lv_btn_OdomState state);
 ...
 */
static inline lv_btn_OdomState lv_imgbtn_get_state(const lv_obj_t * imgbtn)
{

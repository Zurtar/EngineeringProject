...
public:
   ...
   */
  void setStateCallback(std::function<void(OdomState state)> callback);
   ...
   */
  void setData(OdomState state, sensors_t sensors);
...
private:
  ...
  std::function<void(OdomState state)> stateFnc = nullptr;
